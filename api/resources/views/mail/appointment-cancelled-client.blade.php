...
<style>
  ...
  .header { background: #71717a; padding: 28px 32px; }
  .header-title { color: #ffffff; font-size: 20px; font-weight: 700; margin: 0 0 4px; }
  .header-biz { color: #e4e4e7; font-size: 13px; margin: 0; }
  .body { padding: 32px; }
...
<div class="wrapper">
  <div class="card">
    <div class="header">
      <p class="header-title">Appointment cancelled</p>
      <p class="header-biz">{{ $businessName }}</p>
    </div>
    <div class="body">
      <p class="lead">Hi {{ $appt['customer_name'] }}, your appointment with <strong>{{ $businessName }}</strong> has been cancelled.</p>
