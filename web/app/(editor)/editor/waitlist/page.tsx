...
export default function WaitlistPage() {
  ...
  return (
    <EditorShell
      title="Waitlist"
      subtitle="People waiting for a slot to open. When an appointment cancels, the next match gets a claim link."
    >
                ...
                {entries.map(e => (
                  <tr key={e.id} className="border-b border-[rgba(18,18,18,0.05)] last:border-b-0 align-top">
                    ...
                    <td className="px-4 py-3.5 text-sm">
                      ...
                      {e.notes && (
                        <div className="mt-1 text-[12px] text-muted-text italic line-clamp-2">"{e.notes}"</div>
                      )}
                    </td>
                    <td className="px-4 py-3.5 text-sm">
