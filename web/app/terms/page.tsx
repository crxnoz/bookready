  ...
  return (
    <LegalShell eyebrow="Legal" title="Terms of Service" effectiveDate="May 26, 2026">
      ...
      <p>
        ...
        <a href="https://app.bkrdy.me" target="_blank" rel="noopener noreferrer">
          https://app.bkrdy.me
        </a>{' '}
        (the &ldquo;<strong>Site</strong>&rdquo;), as well as any other related
        products and services that refer or link to these legal terms (the{' '}
        &ldquo;<strong>Legal Terms</strong>&rdquo;) (collectively, the{' '}
        &ldquo;<strong>Services</strong>&rdquo;).
      </p>
      <p>
        BookReady is a software platform that helps beauty businesses — such as
        barbershops and salons — run online appointment booking, accept customer
        deposits via Stripe, host a customer-facing booking website, and manage their
        client relationships, all from a single workspace.
      </p>
      <p>
        You can contact us by email at{' '}
        <a href="mailto:daysgraphicnyc@gmail.com">daysgraphicnyc@gmail.com</a> or by
        mail to 447 Broadway, 2nd Fl. — #3000, New York, NY 10013-2562.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you,
        whether personally or on behalf of an entity (&ldquo;<strong>you</strong>&rdquo;),
        and DaysGraphic LLC, concerning your access to and use of the Services. You
      ...
      <p>
        ...
        notifying you by{' '}
        <a href="mailto:legal@mybookready.com">legal@mybookready.com</a>, as stated in
        the email message. By continuing to use the Services after the effective date
      ...
      <ol>
        ...
        <li><a href="#dmca">Digital Millennium Copyright Act (DMCA) notice and policy</a></li>
      ...
      <p>
        ...
        IS&rdquo; for your personal, non-commercial use or internal business purpose
        only.
      </p>
      ...
      <p>
        ...
        &ldquo;<a href="#prohibited">PROHIBITED ACTIVITIES</a>&rdquo; section below,
      ...
      <p>
        ...
        request to:{' '}
        <a href="mailto:daysgraphicnyc@gmail.com">daysgraphicnyc@gmail.com</a>. If we
      ...
      <p>
        ...
        &ldquo;<a href="#prohibited">PROHIBITED ACTIVITIES</a>&rdquo; section
      ...
      <p>
        ...
        (&ldquo;Submissions&rdquo;), you agree to assign to us all intellectual
      ...
      <p>
        ...
        personal information, or other material (&ldquo;Contributions&rdquo;). Any
      ...
      <ul>
        <li>
          ...
          &ldquo;<a href="#prohibited">PROHIBITED ACTIVITIES</a>&rdquo; and will not
      ...
      <p>
        ...
        we consider such Contributions harmful or in breach of these Legal Terms. If
      ...
      <p>
        ...
        &ldquo;<a href="#dmca">DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</a>
        &rdquo; section below.
      </p>
      ...
      <p>
        ...
        Express, Discover), processed securely through Stripe.
      </p>
      <p>
        ...
        transactions and contact you as needed. Sales tax will be added to the price
      ...
      <p>
        ...
        quarterly, or annually — chosen by the customer at signup.
      </p>

      <h3>Free trial</h3>
      <p>
        We offer a 7-day free trial to new users who register with the Services. The
        account will be charged according to the user&rsquo;s chosen subscription at
      ...
      <p>
        ...
        <a href="mailto:daysgraphicnyc@gmail.com">daysgraphicnyc@gmail.com</a>.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          (&ldquo;gifs&rdquo;), 1×1 pixels, web bugs, cookies, or other similar
        ...
        <li>
          Copy or adapt the Services&rsquo; software, including but not limited to
        ...
        <li>
          Upload, post, or display photographs or other images of identifiable
          individuals without obtaining all necessary consents and rights from those
          individuals.
        </li>
        <li>
          Use the Services to send unsolicited promotional or marketing communications
          to your customers. (Anti-spam — protects your sending reputation with
          Resend.)
        </li>
        <li>
          Use the Services to offer or facilitate any goods or services prohibited by
          Stripe&rsquo;s Acceptable Use Policy or by applicable law. (Backstop for
          Stripe&rsquo;s restrictions on adult content, regulated industries, illegal
          services.)
        </li>
        <li>
          Use the Services to impersonate any business or individual that you do not
      ...
      <p>
        ...
        material (collectively, &ldquo;Contributions&rdquo;). Contributions may be
      ...
      <p>
        ...
        <a href="https://app.bkrdy.me/privacy" target="_blank" rel="noopener noreferrer">
          https://app.bkrdy.me/privacy
        </a>
      ...
      <h2 id="dmca">14. Digital Millennium Copyright Act (DMCA) notice and policy</h2>
      ...
      <p>
        ...
        the contact information provided below (a &ldquo;Notification&rdquo;). A copy
      ...
      <p>
        ...
        and include the following information: (1) A physical or electronic signature
        of a person authorized to act on behalf of the owner of an exclusive right
        that is allegedly infringed; (2) identification of the copyrighted work
        claimed to have been infringed, or, if multiple copyrighted works on the
        Services are covered by the Notification, a representative list of such works
        on the Services; (3) identification of the material that is claimed to be
      ...
      <p>
        ...
        contact information provided below (a &ldquo;Counter Notification&rdquo;). To
        ...
        appeared before it was removed or disabled; (2) a statement that you consent
        to the jurisdiction of the Federal District Court in which your address is
        located, or if your address is outside the United States, for any judicial
        district in which we are located; (3) a statement that you will accept service
        of process from the party that filed the Notification or the party&rsquo;s
        ...
        of the material to be removed or disabled; and (6) your physical or electronic
        signature.
      </p>
      <p>
        ...
        such party has filed a court action to restrain you from engaging in
        ...
        costs and attorney&rsquo;s fees. Filing a false Counter Notification
        constitutes perjury.
      </p>
      ...
      <p>
        ...
        YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE YOUR ACCOUNT AND ANY
      ...
      <p>
        ...
        made and to be entirely performed within the State of New York, without regard
      ...
      <p>
        ...
        (&ldquo;AAA&rdquo;) and, where appropriate, the AAA&rsquo;s Supplementary
        Procedures for Consumer Related Disputes (&ldquo;AAA Consumer Rules&rdquo;),
        ...
        excessive, we will pay all arbitration fees and expenses. The arbitration may
        ...
        applicable law, the arbitration will take place in Kings County, New York.
      ...
      <p>
        ...
        located in Kings County, New York, and the Parties hereby consent to, and
      ...
      <p>
        ...
        the Services be commenced more than one (1) year after the cause of action
      ...
      <p>
        ...
        REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES&rsquo;
      ...
      <p>
        ...
        LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX
        (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $100.00 USD. CERTAIN
      ...
      <p>
        ...
        relates to any activity you have undertaken using the Services. You agree that
      ...
      <h2 id="sms">25. SMS text messaging</h2>

      <h3>Program description</h3>
      <p>
        By opting into any BookReady Reminders text messaging program, you expressly
        consent to receive text messages (SMS) to your mobile number. BookReady
        Reminders text messages may include account alerts and appointment reminders.
      </p>

      <h3>Message frequency</h3>
      <p>
        When you opt into BookReady Reminders, you will receive transactional SMS
        messages related to your appointments — including booking confirmations,
        reminders, cancellations, and reschedules — as well as account security
        alerts. Message frequency varies based on your appointment activity; you
        should expect approximately 1–5 messages per booking cycle. Reply STOP to opt
        out at any time. Reply HELP for help. Message and data rates may apply.
      </p>

      <h3>Opting out</h3>
      <p>
        If at any time you wish to stop receiving SMS messages from us, simply reply
        to the text with &ldquo;STOP.&rdquo; You may receive an SMS message confirming
      ...
      <p>
        ...
        or received. The rates are determined by your carrier and the specifics of
        your mobile plan. Carriers are not liable for delayed or undelivered messages.
        If you have any questions about your text plan or data plan, contact your
        wireless provider.
      </p>
      ...
      <p>
        ...
        please reply with the keyword HELP. You can also email us at{' '}
        <a href="mailto:daysgraphicnyc@gmail.com">daysgraphicnyc@gmail.com</a>. If you
        have any questions regarding privacy, please read our Privacy Policy:{' '}
        <a href="https://app.bkrdy.me/privacy" target="_blank" rel="noopener noreferrer">
          https://app.bkrdy.me/privacy
        </a>
        .
      ...
      <h2 id="california">26. California users and residents</h2>
      <p>
      ...
      <h2 id="misc">27. Miscellaneous</h2>
      <p>
