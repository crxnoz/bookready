...
export const metadata: Metadata = {
  ...
  description: 'Set cancellation, no-show, late, and deposit policies on BookReady, and control how customers reschedule or cancel.',
}
  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>No-show</strong>: what happens when a customer doesn&rsquo;t turn up.</li>
      ...
      <ul>
        <li><strong>Cancellation window</strong>: how many hours before an appointment a customer can still cancel themselves.</li>
        <li><strong>Reschedule window</strong>: the same idea for moving an appointment.</li>
      </ul>
      <p>
        Inside the window, customers can self-serve. Outside it, the option is
        locked and they have to contact you, so nobody cancels twenty minutes
        before their slot.
      </p>

      <div className="help-note">
        <p><strong>How customers manage their booking</strong></p>
        <p>Every confirmation email has a secure link. Customers use it to cancel or reschedule (no account or password needed), and the windows above decide what they&rsquo;re allowed to do.</p>
      </div>
      ...
      <p>
        ...
        actually costs the customer something, which means far fewer no-shows. Your
        deposit policy text should make this clear.
      </p>

      <h2>Preventing duplicate bookings</h2>
      <p>
        You can stop the same customer from holding multiple overlapping bookings,
