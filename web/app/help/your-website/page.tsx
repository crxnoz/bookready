...
export default function Page() {
  return (
    <HelpArticle
      slug="your-website"
      intro="Your booking page is the first thing customers see. The Website editor lets you shape every part of it, and a live preview shows your changes instantly."
    >
      ...
      <p>
        ...
        five to eight strong photos converts better than a sprawling album, so pick
      ...
      <p>
        ...
        live the whole time. To see it exactly as a customer would, click{' '}
