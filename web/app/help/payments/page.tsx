  ...
  return (
    ...
    >
      ...
      <p>
        ...
        booking: a fixed amount or a percentage, set per service. The customer pays
      ...
      <p>
        After the appointment you can charge the remaining balance, and customers
        can leave a tip. BookReady can email the customer a secure link to pay their
        balance or tip, with no awkward in-person card fumbling.
      </p>

      <h2>Payouts</h2>
      <p>
        Money from your customers goes to <strong>your</strong> Stripe account and is
        ...
        on the way to your bank. BookReady is just the technology in the middle; you are the
        merchant of record for your customers&rsquo; payments.
      </p>

      <h2>Transactions &amp; refunds</h2>
      <p>
        The <strong>Transactions</strong> tab lists every payment with its status.
        To refund a customer, open the appointment or transaction and choose{' '}
        <strong>Refund</strong>, full or partial. Refunds go back to the
        customer&rsquo;s original card through Stripe.
      </p>

      <h2>Two kinds of payments: don&rsquo;t mix them up</h2>
      <p>
        Everything on this page is about <strong>your customers paying you</strong>.
        That&rsquo;s separate from <strong>your BookReady subscription</strong>{' '}
        (what you pay us to use the platform), which lives under Billing. See{' '}
