...
export default function Page() {
  return (
    <HelpArticle
      ...
      intro="This is about your BookReady subscription: what you pay us to run your booking business. (Money your customers pay you is separate; that's under Payments.)"
    >
