        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          {!sent ? (
            <>
              ...
              {isResend && (
                <div className="px-3 py-2 bg-[rgba(180,120,0,0.06)] border border-[rgba(180,120,0,0.30)] text-xs text-warning">
              ...
              <div>
                ...
                <div className="flex items-stretch border border-hairline-strong">
                  ...
                  <button
                    ...
                    className="px-3 border-l border-hairline-strong bg-white hover:bg-[rgba(18,18,18,0.04)] flex items-center gap-1.5 text-2xs font-semibold uppercase tracking-[0.08em]"
        ...
        <div className="flex gap-2 p-5 border-t border-hairline-soft">
          {!sent ? (
            ...
            <button
              type="button"
              onClick={onClose}
              className="flex-1 bg-near-black text-white text-2xs font-bold tracking-[0.18em] uppercase py-3 hover:opacity-90 transition-colors"
            >
              Done
            </button>
          )}
