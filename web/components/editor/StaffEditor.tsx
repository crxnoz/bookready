  ...
  return (
    <div className="flex flex-col min-h-full bg-cream">
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-5">
        ...
        {placeholderCount > 0 && (
          <div className="bg-blush border border-[rgba(18,18,18,0.10)] px-4 py-3 flex items-start gap-2">
    ...
    <div className={cn(
      ...
      <div className="p-4">
        ...
        <div className="flex items-start gap-3">
          {/* Avatar */}
          <div className="w-12 h-12 bg-cream border border-[rgba(18,18,18,0.08)] flex-shrink-0 overflow-hidden">
            {member.photo_url
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {placeholder && (
                <span className="text-[9px] font-bold tracking-[0.06em] uppercase px-2 py-0.5 flex-shrink-0 bg-blush text-near-black">
                  Email needed
                </span>
              )}
            </div>
        ...
        {/* Actions */}
        <div className="flex items-center gap-2 mt-3 pt-3 border-t border-[rgba(18,18,18,0.06)] flex-wrap">
          <button
            onClick={onEdit}
          ...
          <button
            ...
            className={cn(
              'flex items-center gap-1.5 text-[11px] font-semibold border px-3 py-1.5 transition-colors',
              expanded
                ? 'bg-near-black text-white border-near-black'
                : 'text-near-black border-[rgba(18,18,18,0.15)] hover:border-near-black',
            )}
          >
      ...
      {/* Schedule panel */}
      {expanded && (
        <div className="border-t border-[rgba(18,18,18,0.08)] bg-cream/40 p-4 space-y-5">
...
function StaffHoursPanel({ staffId }: { staffId: number }) {
  ...
  return (
    <div>
      ...
      {loading && (
        <p className="text-[11px] text-muted-text">Loading hours…</p>
      )}
      {error && (
            ...
            <div key={day.day_of_week} className="flex items-center gap-2 px-3 py-2 flex-wrap">
              <div className="flex items-center gap-2 w-24 flex-shrink-0">
                <input
                  ...
                  className="w-4 h-4 accent-near-black"
                />
                <span className="text-[11px] font-semibold text-near-black">{day.day_name.slice(0, 3)}</span>
              </div>
              {day.is_open ? (
                <div className="flex items-center gap-1.5 flex-wrap">
                  <input
                    ...
                    className="border border-[rgba(18,18,18,0.15)] bg-white px-2 py-1 text-[11px] text-near-black focus:outline-none focus:border-near-black"
                  />
                  <span className="text-muted-text text-[10px]">to</span>
                  <input
                    type="time"
                    ...
                    className="border border-[rgba(18,18,18,0.15)] bg-white px-2 py-1 text-[11px] text-near-black focus:outline-none focus:border-near-black"
                  />
                  <span className="text-muted-text text-[10px] ml-1">break</span>
                  <input
                    type="time"
                ...
                <span className="text-[11px] text-muted-text italic">Off</span>
              )}
            </div>
          ))}
        </div>
...
function StaffBlockedDatesPanel({ staffId }: { staffId: number }) {
  ...
  return (
    <div>
      <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-muted-text inline-flex items-center gap-1.5 mb-2">
      ...
      {error && (
        <p className="text-[11px] text-red-700 flex items-center gap-1.5 mb-2">
          <AlertCircle size={11} /> {error}
        </p>
      )}
          ...
          {rows.map(r => (
            <div key={r.id} className="flex items-center justify-between gap-2 px-3 py-2">
              <div className="min-w-0">
                <p className="text-[11px] font-semibold text-near-black">{rangeLabel(r)}</p>
                {r.reason && (
