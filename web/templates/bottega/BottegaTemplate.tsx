...
/* ── Gallery: force 3 cols at every breakpoint so 6 items always land
   as a 3×2 grid (two rows of three). Default shared cascade goes
   1 → 2 → 3 across mobile/tablet/desktop; Bottega skips that and
   stays 3-col throughout. Gap scales up at wider viewports. ── */
.bottega-template .brk-gallery-grid {
  grid-template-columns: repeat(3, 1fr);
  gap: 10px;
}
@media (min-width: 641px) {
  .bottega-template .brk-gallery-grid { gap: 16px; }
}
