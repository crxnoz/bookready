 ...
 *     state lands)
 *   - unauthed: small "Sign in" button → opens TfrAuthModal on this
 ...
 *
 * Why no own customerMe() call: the TfrCustomerAuthProvider higher up
...
export default function TfrCustomerAccountWidget() {
  const { user, authChecked, open, signOut } = useTfrCustomerAuth()
